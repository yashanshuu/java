...
//add a static method to return List of some products'
	static List<Product> populateProductList() {
		...
		list.add(new Product(71, "Banana", "Inexpensive Fruit", 10, 40, FRUITS, parse("2023-05-06")));
		list.add(new Product(17, "Strawberry", "Type of a berry", 50, 150, FRUITS, parse("2023-01-04")));
